...
module.exports = function(RED) {
    var MCP = require("./mcp23008.js");
    String.prototype.endsWith = function(suffix) {
        return this.match(suffix + "$") == suffix;
    };

    function mcp23008_Node(config) {
        ...
        function mcp23008_set_all_outputs(state) {
            for (var pin = 0; pin < 8; pin++) {
                mcp23008_process(pin, state);
            }
        }

        function mcp23008_process(pin, state) {
    ...
    RED.nodes.registerType("mcp23008", mcp23008_Node);
}